...
/* harmony default export */ var CartItemList = (function (_ref) {
  ...
  if (items.length === 0) {
    return external_react_default.a.createElement(external_semantic_ui_react_["Message"], {
      warning: true
    }, external_react_default.a.createElement(external_semantic_ui_react_["Message"].Header, null, "Your Cart is empty"), external_react_default.a.createElement("p", null, "You'll need to add some items to the cart before you checkout."));
  }
...
/* harmony default export */ var CartSummary = (function (_ref) {
  var formatted = _ref.display_price.with_tax.formatted;
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_semantic_ui_react_["Divider"], null), external_react_default.a.createElement(external_semantic_ui_react_["Segment"], {
    clearing: true,
    size: "large"
  }, external_react_default.a.createElement("strong", null, "Sub total:"), " ", formatted, external_react_default.a.createElement(link_default.a, {
    href: "/checkout",
    prefetch: true,
    passHref: true
...
function (_React$Component) {
  ...
  function Cart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleRemoveFromCart",
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(itemId) {
        var cartId, _ref2, data, meta;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Object(moltin["e" /* removeFromCart */])(itemId, cartId);
  ...
  _createClass(Cart, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 5;
                return Object(moltin["b" /* getCartItems */])(cartId);
    ...
    value: function render() {
      ...
      })), !loading && external_react_default.a.createElement(CartSummary, meta));
    }
  }]);
